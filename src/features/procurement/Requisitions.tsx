...
import { requisitions } from "@/lib/placeholder-data";
...
type Requisition = { reqNumber: string, requestedBy: string, date: string, status: string, items: RequisitionItem[] };
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-end">
        <Button><PlusCircle className="mr-2 h-4 w-4" /> New Requisition</Button>
      </div>
